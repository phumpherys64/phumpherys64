...
# Note: kubectl cp requires that the 'tar' binary is present in your container image. 
# If 'tar' is not present, kubectl cp will fail. For advanced use cases, such as symlinks, 
# wildcard expansion or file mode preservation consider using kubectl exec.
